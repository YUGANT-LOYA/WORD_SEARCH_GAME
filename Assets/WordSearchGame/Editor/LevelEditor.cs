...
namespace YugantLoyaLibrary.WordSearchGame
{
    ...
    {
        SerializedProperty editorWordList, enumListProperty, levelDataInfo, levelData, dataRetrivingFile;
        ...
        private void OnEnable()
        {
            ...
            dataRetrivingFile = serializedObject.FindProperty("retrieveDatafile");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(dataRetrivingFile);
                ...
                if (levelGenerator.wordList.Count > 0)
                {
                    ...
                    if (GUILayout.Button("Finalize Level"))
                    {
                        ...
                        if (filePath != null)
                        {
                            ...
                            if (textFile != null)
                            {
                                levelGenerator.levelData.level_CSV = textFile;
                                Debug.Log("CSV : " + levelGenerator.levelData.level_CSV.name);
                            }
                        }
                    }
